...
export function useQueryState(key, { history = 'replace', parse = x => x, serialize = String, defaultValue = undefined } = {
    ...
    const updateUrl = React.useMemo(() => (history === 'push' ? router === null || router === void 0 ? void 0 : router.push : router === null || router === void 0 ? void 0 : router.replace), [history]);
    ...
    const value = React.useMemo(getValue, [router === null || router === void 0 ? void 0 : router.query[key]]);
