...
export function useQueryStates(keys, { history = 'replace' } = {}) {
    ...
    const updateUrl = React.useMemo(() => (router === null || router === void 0 ? void 0 : router.isReady)
        ? history === 'push'
    ...
    const values = React.useMemo(getValues, Object.keys(keys).map(key => router === null || router === void 0 ? void 0 : router.query[key]));
